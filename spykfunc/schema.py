...
SYNAPSE_CLASS_SCHEMA = T.StructType([
    ...
    T.StructField("gsynVar", T.FloatType(), False),
    T.StructField("nsyn", T.FloatType(), False),
    T.StructField("nsynVar", T.FloatType(), False),
    T.StructField("dtc", T.FloatType(), False),
    T.StructField("dtcVar", T.FloatType(), False),
    T.StructField("u", T.FloatType(), False),
    T.StructField("uVar", T.FloatType(), False),
    T.StructField("d", T.FloatType(), False),
    T.StructField("dVar", T.FloatType(), False),
    T.StructField("f", T.FloatType(), False),
    T.StructField("fVar", T.FloatType(), False),
